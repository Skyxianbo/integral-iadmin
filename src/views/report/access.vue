            ...
            <article class='summarize panel-body flex'>
                <div class='left '>
                    ...
                    <div class='flex flex-center-h item-4'>
                        <div class='gray-item'>
                            <p>昨日</p>
                            <b>{{total.yesterday_count_uv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>今日</p>
                            <b>{{total.today_count_uv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>上周</p>
                            <b>{{total.lastweekend_count_uv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>本周</p>
                            <b>{{total.thisweekend_count_uv}}</b>
                        </div>
                    </div>
                </div>
                <div class='right '>
                    ...
                    <div class='flex flex-center-h item-4'>
                        <div class='gray-item'>
                            <p>昨日</p>
                            <b>{{total.yesterday_count_pv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>今日</p>
                            <b>{{total.today_count_pv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>上周</p>
                            <b>{{total.lastweekend_count_pv}}</b>
                        </div>
                        <div class='gray-item'>
                            <p>本周</p>
                            <b>{{total.thisweekend_count_pv}}</b>
                        </div>
                    </div>
                </div>
            </article>
...
export default {
    ...
    methods: {
        ...
        getTotal() {
            this.requestApi("/report/view_total", {}, (response) => {
                this.total = response.data;
            })
        },
        getDay(callback, params) {
            this.requestApi("/report/view_day", {
        ...
        getOrigin(callback, params) {
            this.requestApi("/report/view_origin", {
                type: params.type,
                startdate: params.startdate,
                enddate: params.enddate,
            }, (response) => {
